...
const designerProjects = [
  { id: '1', title: 'ActiveArc App UI/UX', description: 'Fitness app design flow — onboarding, workouts, calories, light & dark themes', slug: 'activearc-ui', image: '/assets/images/projects/activearc-ui.png' },
  // { id: '2', title: 'App Redesign', description: 'User-centered fitness app redesign', slug: 'app-redesign', image: '/assets/images/projects/app-redesign.jpg' },
  // { id: '3', title: 'Marketing Campaign', description: 'Digital campaign visuals and assets', slug: 'marketing-campaign', image: '/assets/images/projects/marketing-campaign.jpg' },
];
  ...
  <section className="min-h-screen pt-28 pb-24 px-6">
    <div className="max-w-7xl mx-auto w-full">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="mb-12">
        <h1 className="font-fraunces text-4xl md:text-5xl font-semibold text-foreground mb-4">Designer Projects</h1>
        <p className="text-muted-foreground text-lg">UI/UX and visual design work</p>
      </motion.div>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        {designerProjects.map((p, i) => (
